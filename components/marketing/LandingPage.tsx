    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex flex-1 flex-col">
        ...
        <section className="bg-grain">
          <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-14 px-6 py-20 sm:px-10 lg:grid-cols-[1.05fr_1fr] lg:py-28">
            <div className="flex flex-col items-start gap-6">
              <span className="animate-fade-up inline-flex items-center gap-2 rounded-full border border-border-strong bg-surface px-3 py-1 text-xs font-medium text-ink-soft">
                Works offline. Merges without conflict.
              </span>
              <h1
                className="animate-fade-up font-serif text-4xl leading-[1.1] font-semibold text-ink sm:text-5xl"
              ...
              <p
                className="animate-fade-up max-w-md text-base leading-relaxed text-ink-soft"
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {FEATURES.map((feature, index) => (
                <Reveal key={feature.title} delayMs={(index % 3) * 100}>
                  <div className="flex h-full flex-col gap-4 rounded-2xl border border-border bg-paper p-6 transition-all duration-300 hover:-translate-y-1 hover:border-border-strong hover:shadow-lg hover:shadow-ink/5">
                    <span
        ...
        <section className="border-t border-border">
          <Reveal className="mx-auto flex w-full max-w-6xl flex-col items-center gap-6 px-6 py-20 text-center sm:px-10">
